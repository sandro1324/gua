...
function getCardImagePath(card) {
    ...
    if (card.type === 'major') {
        ...
        subDir = `minor/${card.suit.toLowerCase()}`;
    }
...
function validateCardPath(path) {
    return new Promise((resolve, reject) => {
        ...
        img.onerror = () => {
            ...
            fallbackImg.onerror = () => {
                console.error('详细路径信息:', {
                    attemptedPath: path,
                    fallbackPath: fallbackPath,
                    expectedStructure: 'frontend/cards/[major|minor/suit]/*.jpg'
                });
...
// 统一导出
export {
    majorArcanaData as majorArcana,
    minorArcanaData as minorArcana,
    spreadPositionsConfig as spreadPositions,
    getCardImagePath,
    validateCardPath
}; 