...
const minorArcanaData = {
    ...
    pentacles: {
        ...
        "02": {
            ...
            type: "minor",
            suit: "pentacles",
            image: "02-Two-of-Pentacles.jpg",
            element: "earth",
            keywords: ["平衡", "适应", "优先"],
            keywordsCN: ["平衡", "适应", "优先"],
            keywordsEN: ["Balance", "Adaptability", "Prioritization"],
            meanings: {
                upright: "Multiple priorities, time management, adaptability",
                uprightCN: "多重优先事项、时间管理、适应性",
                reversed: "Over-committed, disorganization, reprioritization",
                reversedCN: "过度承诺、无序、重新排序"
            }
        },
        "03": {
            id: 3,
            ...
            type: "minor",
            suit: "pentacles",
            image: "03-Three-of-Pentacles.jpg",
            element: "earth",
            keywords: ["团队合作", "学习", "实施"],
            keywordsCN: ["团队合作", "学习", "实施"],
            keywordsEN: ["Teamwork", "Learning", "Implementation"],
            meanings: {
                upright: "Teamwork, collaboration, learning, implementation",
                uprightCN: "团队合作、协作、学习、实施",
                reversed: "Disharmony, misalignment, working alone",
                reversedCN: "不和谐、不一致、独自工作"
            }
        },
        "04": {
            id: 4,
            ...
            type: "minor",
            suit: "pentacles",
            image: "04-Four-of-Pentacles.jpg",
            element: "earth",
            keywords: ["控制", "稳定", "安全"],
            keywordsCN: ["控制", "稳定", "安全"],
            keywordsEN: ["Control", "Stability", "Security"],
            meanings: {
                upright: "Saving money, security, conservatism, scarcity",
                uprightCN: "存钱、安全、保守、稀缺",
                reversed: "Over-spending, greed, self-protection",
                reversedCN: "过度消费、贪婪、自我保护"
            }
        },
        "05": {
            id: 5,
            ...
            type: "minor",
            suit: "pentacles",
            image: "05-Five-of-Pentacles.jpg",
            element: "earth",
            keywords: ["贫困", "孤立", "不安"],
            keywordsCN: ["贫困", "孤立", "不安"],
            keywordsEN: ["Poverty", "Isolation", "Insecurity"],
            meanings: {
                upright: "Financial loss, poverty, lack mindset, isolation",
                uprightCN: "财务损失、贫困、缺乏心态、孤立",
                reversed: "Recovery from financial loss, spiritual poverty",
                reversedCN: "从财务损失中恢复、精神贫困"
            }
        },
        "06": {
            id: 6,
            ...
            type: "minor",
            suit: "pentacles",
            image: "06-Six-of-Pentacles.jpg",
            element: "earth",
            keywords: ["慷慨", "繁荣", "分享"],
            keywordsCN: ["慷慨", "繁荣", "分享"],
            keywordsEN: ["Generosity", "Prosperity", "Sharing"],
            meanings: {
                upright: "Giving, receiving, sharing wealth, generosity",
                uprightCN: "给予、接受、分享财富、慷慨",
                reversed: "Selfishness, debt, one-sided charity",
                reversedCN: "自私、债务、单方面慈善"
            }
        },
        "07": {
            id: 7,
            ...
            type: "minor",
            suit: "pentacles",
            image: "07-Seven-of-Pentacles.jpg",
            element: "earth",
            keywords: ["耐心", "评估", "投资"],
            keywordsCN: ["耐心", "评估", "投资"],
            keywordsEN: ["Patience", "Assessment", "Investment"],
            meanings: {
                upright: "Long-term view, sustainable results, perseverance",
                uprightCN: "长期视角、可持续结果、毅力",
                reversed: "Lack of long-term vision, limited success or reward",
                reversedCN: "缺乏长期愿景、有限的成功或回报"
            }
        },
        "08": {
            id: 8,
            ...
            type: "minor",
            suit: "pentacles",
            image: "08-Eight-of-Pentacles.jpg",
            element: "earth",
            keywords: ["技能", "发展", "勤奋"],
            keywordsCN: ["技能", "发展", "勤奋"],
            keywordsEN: ["Skill", "Development", "Diligence"],
            meanings: {
                upright: "Apprenticeship, repetitive tasks, mastery, skill development",
                uprightCN: "学徒、重复任务、掌握、技能发展",
                reversed: "Lack of passion, uninspired, no motivation",
                reversedCN: "缺乏激情、无灵感、无动力"
            }
        },
        "09": {
            id: 9,
            ...
            type: "minor",
            suit: "pentacles",
            image: "09-Nine-of-Pentacles.jpg",
            element: "earth",
            keywords: ["富足", "独立", "安全"],
            keywordsCN: ["富足", "独立", "安全"],
            keywordsEN: ["Abundance", "Independence", "Security"],
            meanings: {
                upright: "Abundance, luxury, self-sufficiency, financial independence",
                uprightCN: "富足、奢华、自给自足、财务独立",
                reversed: "Over-investment in work, financial setbacks",
                reversedCN: "过度投资于工作、财务挫折"
            }
        },
        "10": {
            id: 10,
            ...
            type: "minor",
            suit: "pentacles",
            image: "10-Ten-of-Pentacles.jpg",
            element: "earth",
            keywords: ["财富", "继承", "家庭"],
            keywordsCN: ["财富", "继承", "家庭"],
            keywordsEN: ["Wealth", "Inheritance", "Family"],
            meanings: {
                upright: "Wealth, financial security, family, long-term success",
                uprightCN: "财富、财务安全、家庭、长期成功",
                reversed: "Financial failure, loneliness, loss",
                reversedCN: "财务失败、孤独、失落"
            }
        },
        "11": {
            id: 11,
        ...
        "12": {
            ...
            type: "minor",
            suit: "pentacles",
            image: "12-Knight-of-Pentacles.jpg",
            element: "earth",
            keywords: ["效率", "责任", "耐心"],
            keywordsCN: ["效率", "责任", "耐心"],
            keywordsEN: ["Efficiency", "Responsibility", "Patience"],
            meanings: {
                upright: "Hard work, productivity, routine, conservatism",
                uprightCN: "努力工作、生产力、常规、保守",
                reversed: "Laziness, obsessiveness, work without reward",
                reversedCN: "懒惰、强迫、无回报的工作"
            }
        },
        "13": {
            id: 13,
            ...
            type: "minor",
            suit: "pentacles",
            image: "13-Queen-of-Pentacles.jpg",
            element: "earth",
            keywords: ["实用", "母性", "安全"],
            keywordsCN: ["实用", "母性", "安全"],
            keywordsEN: ["Practicality", "Motherhood", "Security"],
            meanings: {
                upright: "Practical, homely, motherly, down-to-earth",
                uprightCN: "实用、居家、母性、脚踏实地",
                reversed: "Imbalance in work/family commitments",
                reversedCN: "工作/家庭承诺失衡"
            }
        },
        "14": {
            id: 14,
            ...
            type: "minor",
            suit: "pentacles",
            image: "14-King-of-Pentacles.jpg",
            element: "earth",
            keywords: ["安全", "控制", "权力"],
            keywordsCN: ["安全", "控制", "权力"],
            keywordsEN: ["Security", "Control", "Power"],
            meanings: {
                upright: "Wealth, business, leadership, security, discipline",
                uprightCN: "财富、商业、领导、安全、纪律",
...
function getCardImagePath(card) {
    if (!card || !card.image) {
        console.error('卡牌数据不完整，无法生成图片路径:', card);
        return './cards/card-back.png';  // 默认返回卡背
    }
    
    // 检查图片文件名是否已经包含完整路径
    if (card.image.includes('/')) {
        return card.image;  // 如果已经是完整路径，直接返回
    }
    
    // 直接从cards根目录加载图片，因为所有图片都已经放在这里
...
function validateCardPath(path) {
    return new Promise((resolve, reject) => {
        ...
        // 尝试主路径
        const tryPath = (currentPath) => {
            // 如果已经尝试过这个路径，跳过
            if (attemptedPaths.includes(currentPath)) {
                console.log(`已尝试过路径，跳过: ${currentPath}`);
                return tryNextPath();
            }
            
            // 记录尝试过的路径
            attemptedPaths.push(currentPath);
            console.log(`正在尝试路径(${attemptedPaths.length}): ${currentPath}`);
            ...
            img.onerror = () => {
                console.warn('图片加载失败:', currentPath);
                tryNextPath();
            };
        ...
        const tryNextPath = () => {
            // 从当前路径提取文件名
            const currentPath = attemptedPaths[attemptedPaths.length - 1];
            const pathParts = currentPath.split('/');
            let fileName = pathParts[pathParts.length - 1];
            
            // 尝试不同的路径组合
            if (currentPath.includes('/major/')) {
                // 从major子目录转到根目录
                tryPath(`./cards/${fileName}`);
            } 
            else if (currentPath.includes('/cups/')) {
                // 从cups子目录转到根目录
                tryPath(`./cards/${fileName}`);
            }
            else if (currentPath.includes('/wands/')) {
                // 从wands子目录转到根目录
                tryPath(`./cards/${fileName}`);
            }
            else if (currentPath.includes('/swords/')) {
                // 从swords子目录转到根目录
                tryPath(`./cards/${fileName}`);
            }
            else if (currentPath.includes('/pentacles/')) {
                // 从pentacles子目录转到根目录
                tryPath(`./cards/${fileName}`);
            }
            else if (currentPath.startsWith('./cards/') && !currentPath.includes('/')) {
                // 尝试不同的文件名大小写组合
                ...
                // 尝试每个单词首字母大写
                const withCapitalizedWords = origName.split('-').map(word => 
                    word.charAt(0).toUpperCase() + word.slice(1).toLowerCase()
                ).join('-');
                
                if (withCapitalizedWords !== origName) {
                    tryPath(`./cards/${withCapitalizedWords}`);
                    return;
                }
                ...
                // 尝试首字母大写
                fileName = origName.charAt(0).toUpperCase() + origName.slice(1).toLowerCase();
                if (fileName !== origName) {
                    tryPath(`./cards/${fileName}`);
                    return;
                }
                ...
                if (fileName.includes('-of-')) {
                    const ofVersion = fileName.replace('-of-', '-Of-');
                    tryPath(`./cards/${ofVersion}`);
                    return;
                }
                
                // 所有尝试都失败了
                reject(new Error(`所有路径尝试均失败: ${attemptedPaths.join(', ')}`));
            } 
            else {
                // 如果所有尝试都失败，那么拒绝Promise
                reject(new Error(`所有路径尝试均失败: ${attemptedPaths.join(', ')}`));
            }
        };
...
function generateTarotReading(question, cardName, position) {
    ...
    if (!card) {
        console.error(`无法找到卡牌: ${cardName}`);
        return `无法找到卡牌: ${cardName}。请检查卡牌名称或重新洗牌。`;
    }
    
    // 确保card.meanings存在
    if (!card.meanings) {
        console.error(`卡牌数据不完整, 缺少meanings属性: ${cardName}`, card);
        return `卡牌数据不完整: ${cardName}。请联系管理员修复数据。`;
    }
    ...
    // 构建基础解读
    let reading = `${card.nameEN || card.name} (${card.nameCN || card.name}) 在 ${position} 位置的解读:\n\n`;
    reading += `状态: ${isReversed ? '逆位' : '正位'}\n\n`;

    // 安全访问属性
    const keywords = card.keywordsCN || card.keywords || [];
    const upright = card.meanings.uprightCN || card.meanings.upright || "无正位解释";
    const reversed = card.meanings.reversedCN || card.meanings.reversed || "无逆位解释";
    
    reading += `关键词: ${keywords.join('、')}\n\n`;
    
    // 根据正逆位显示对应的含义
    if (isReversed) {
        reading += `逆位含义: ${reversed}\n\n`;
        reading += `正位参考: ${upright}\n\n`;
    } else {
        reading += `正位含义: ${upright}\n\n`;
        reading += `逆位参考: ${reversed}\n\n`;
    }
    ...
    try {
        ...
        // 添加逆位特殊解读
        if (isReversed) {
            reading += `\n\n逆位特别提示: 逆位卡牌通常表示能量受阻、内在化或与正位相反的含义。在这种情况下，您可能需要更加关注内在的感受和潜意识中的阻碍。`;
        }
    } catch (error) {
        console.error("生成个性化解读出错:", error);
        reading += "无法生成个性化解读，请尝试重新抽牌。";
    }
...
function findCardByName(name) {
    ...
    for (const suit in minorArcanaData) {
        for (const id in minorArcanaData[suit]) {
            if (minorArcanaData[suit][id].name === name || minorArcanaData[suit][id].nameCN === name) {
                console.log(`在小阿卡纳 ${suit} 中找到卡牌: ${name}`);
    ...
    // 如果精确匹配没找到，尝试部分匹配
    console.warn(`没有找到精确匹配的卡牌: "${name}"，尝试部分匹配`);
    ...
    for (const id in majorArcanaData) {
        ...
        if (card.name && card.name.includes(name) || 
            card.nameCN && card.nameCN.includes(name) ||
            name.includes(card.name) || 
            name.includes(card.nameCN)) {
            console.log(`在大阿卡纳中找到部分匹配: ${card.name}`);
            bestMatch = card;
            break;
        }
    }
        ...
        for (const suit in minorArcanaData) {
            ...
            for (const id in minorArcanaData[suit]) {
                ...
                if (card.name && card.name.includes(name) || 
                    ...
                    name.includes(card.name) || 
                    name.includes(card.nameCN)) {
                    console.log(`在小阿卡纳 ${suit} 中找到部分匹配: ${card.name}`);
                    bestMatch = card;
                    break;
                }
            }
...
// 获取随机牌组
function getRandomDeck(numCards, reversedProbability = 0.3) {
    // 获取所有卡牌
    const allCards = [
    ...
    return shuffledDeck.slice(0, numCards).map(card => ({
        ...card,
        reversed: Math.random() < reversedProbability // 可配置的逆位概率
    }));
}
